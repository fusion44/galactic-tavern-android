package me.stammberger.starcitizeninformer.stores.db.resolvers;
...
import me.stammberger.starcitizeninformer.stores.db.tables.commlink.ContentBlock4Table;
...
public class ContentWrapperGetResolver extends DefaultGetResolver<Wrapper> {
    ...
    public Wrapper mapFromCursor(@NonNull Cursor cursor) {
        final StorIOSQLite storIOSQLite = SciApplication.getInstance().getStorIOSQLite();
